...
def main():
    print("*****-- LOOP EAST 1 --******")
    new_hex_grid = HexGrid(init_file="weather_flower.json", current_position=(2, 2))
    ...
    print("*****-- LOOP EAST 2 --******")
    new_hex_grid = HexGrid(init_file="weather_flower.json", current_position=(0, 2))
    print(f"Current position : {new_hex_grid.current_position}")
    ...
    new_hex_grid = HexGrid(init_file="weather_flower.json", current_position=(-2, 0))
    print(f"Current position : {new_hex_grid.current_position}")
    new_position = new_hex_grid.move_current_position("SE")
    print(f"Current position : {new_position}\n")
    ...
    new_hex_grid = HexGrid(init_file="weather_flower.json", current_position=(1, -1))
    print(f"Current position : {new_hex_grid.current_position}")
    new_position = new_hex_grid.move_current_position("N")
    print(f"Current position : {new_position}\n")

    print("*****-- STOP NORTH EAST --******")
    new_hex_grid = HexGrid(init_file="weather_flower.json", current_position=(2, 1))
    print(f"Current position : {new_hex_grid.current_position}")
    new_position = new_hex_grid.move_current_position("N")
    print(f"Current position : {new_position}\n")
